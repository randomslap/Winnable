            ...
            <Container>
                <Row>
                    ...
                    <Card className="cardTwo">
                        <Row>
                            <Col md={2}>
                                <h3 className="">Team Owner:</h3>
                            </Col>
                            <Col className="text-right" md={10}>
                                <Button className="btn btn-primary">Apply <i class="fas fa-paper-plane"></i></Button>
                            </Col>
                        </Row>
                        <Row>
                            <Col md={2}>
